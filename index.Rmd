...
```{r out.width='200%', echo=F, fig.alt="RUG and RLadies chapter stats"}
knitr::include_graphics("img/2023_rladies_rugs_dashboard.jpg")
```
...
install.packages("rmarkdown", # Convert R Markdown documents into a variety of formats
